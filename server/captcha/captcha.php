...
{
	$text = substr(str_shuffle("abcefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890"), 0, rand(4, 8));
	$_SESSION['captcha'] = strtolower($text);
	$image = imagecreatetruecolor(220, 80);
	ImageFill($image, 0, 0, ImageColorAllocate($image, 255, 255, 255));
	$rot = rand(-15.0, 15.0);
	imagettftext($image, rand(17.0, 21.0), $rot, rand(5.0, 30.0), 50-($rot*-1.4), rand_col($image), "./resources/".rand(0, 6).".ttf", $text);
	$lines = rand(1, 4);
	for($i=0;$i<$lines;++$i)
