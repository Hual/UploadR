 ...
 * @editor  Nikola "King_Hual" Yanakiev
 */
public class GlobalScreen {
	...
	{
		return ("hooklib"+System.mapLibraryName("").substring(System.mapLibraryName("").lastIndexOf('.'))).replaceAll("\\.jnilib$", "\\.dylib");
	}
	
	public static String getLibraryPath() throws UnsupportedEncodingException
	{
	...
	public static boolean libraryExists()
	{
		try
		{
			return new File(getLibraryPath()).exists();
		}
		catch(Exception e)
		{
			return false;
